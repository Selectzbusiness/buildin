      ...
      <div className="p-6 flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div>
              <h3 className="text-xl font-bold text-[#185a9d] group-hover:text-[#12406a] truncate">{internship.title}</h3>
              <div className="text-base font-medium text-gray-700 mt-1 truncate">{internship.company || 'Unknown Company'}</div>
            </div>
            {/* Company Logo */}
