      ...
      <div className="max-w-5xl mx-auto px-2 sm:px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
          <div className="flex items-center gap-6 flex-1">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-[#185a9d] mb-1">{internship.title}</h1>
              <div className="text-lg text-gray-700 font-semibold mb-1">{internship.company}</div>
              <div className="flex flex-wrap gap-2 mt-2">
                <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiBriefcase />{internship.type}</span>
                <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiMapPin />{internship.location ? (typeof internship.location === 'object' && internship.location !== null ? [(internship.location as any).city, (internship.location as any).area].filter(Boolean).join(', ') : internship.location) : 'Not specified'}</span>
                <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiDollarSign />{internship.stipend}</span>
                <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiClock />{postedDate}</span>
                <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiUsers />{openings} Openings</span>
                <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiUserCheck />{applicants}+ Applicants</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1 space-y-8">
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">Internship Description</h2>
              <p className="text-gray-700 leading-relaxed whitespace-pre-line">{internship.description}</p>
            </section>
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">Role Highlights</h2>
            ...
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">Key Skills</h2>
              <div className="flex flex-wrap gap-2">
                {keySkills.map((skill: string, idx: number) => (
                  <span key={idx} className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold border border-[#d1e7f7]">{skill}</span>
                ))}
              </div>
            </section>
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">Education & Eligibility</h2>
              <div className="text-gray-700 mb-2"><b>Education:</b> {education}</div>
              <div className="text-gray-700 mb-2"><b>Department:</b> {department}</div>
              <div className="text-gray-700 mb-2"><b>Industry:</b> {industry}</div>
              <div className="text-gray-700 mb-2"><b>Role Category:</b> {roleCategory}</div>
            </section>
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">About Company</h2>
              ...
              <div className="text-gray-700 mb-2">{industry}</div>
              <div className="flex gap-2 mt-2">
                <a href={companyWebsite} className="text-[#185a9d] hover:underline">Website</a>
                <a href={companyLinkedIn} className="text-[#185a9d] hover:underline">LinkedIn</a>
            </div>
            </section>
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">Beware of imposters!</h2>
            ...
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">Similar Internships</h2>
          ...
          <aside className="w-full md:w-80 flex-shrink-0 space-y-6">
            <div className="bg-white rounded-2xl shadow p-6 flex flex-col items-center">
              ...
              <div className="font-bold text-lg text-[#185a9d] mb-1">{internship.company}</div>
              <div className="text-gray-600 text-sm mb-2">{industry}</div>
              <a href={companyWebsite} className="text-[#185a9d] hover:underline text-sm">Visit Website</a>
              <div className="flex gap-2 mt-2">
                <a href={companyLinkedIn} className="text-[#185a9d] hover:underline"><FiShare2 /></a>
