      ...
      <div className="max-w-5xl mx-auto px-2 sm:px-4 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 md:p-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-8">
          <div className="flex items-center gap-6 flex-1">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-[#185a9d] mb-1">{job.title}</h1>
              <div className="text-lg text-gray-700 font-semibold mb-1">{job.companies.name}</div>
              <div className="flex flex-wrap gap-2 mt-2">
                <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiBriefcase />{job.job_type}</span>
                <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiMapPin />{job.location ? (typeof job.location === 'object' && job.location !== null ? [(job.location as any).city, (job.location as any).area].filter(Boolean).join(', ') : job.location) : 'Not specified'}</span>
                {typeof job.salary_min === 'number' && typeof job.salary_max === 'number' && (
                  <span className="inline-flex items-center gap-1 bg-[#e3f0fa] text-[#185a9d] px-3 py-1 rounded-full text-xs font-semibold"><FiDollarSign />${job.salary_min.toLocaleString()} - ${job.salary_max.toLocaleString()}</span>
                )}
        ...
        <div className="flex flex-col md:flex-row gap-8">
          <div className="flex-1 space-y-8">
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">Job Description</h2>
            ...
            <section className="bg-white rounded-2xl shadow p-6">
              ...
              <div className="text-gray-700 mb-2">{job.companies.description}</div>
            ...
            <section className="bg-white rounded-2xl shadow p-6">
              <h2 className="text-xl font-bold text-[#185a9d] mb-3">Similar Jobs</h2>
          ...
          <aside className="w-full md:w-80 flex-shrink-0 space-y-6">
            <div className="bg-white rounded-2xl shadow p-6 flex flex-col items-center">
              ...
              <div className="font-bold text-lg text-[#185a9d] mb-1">{job.companies.name}</div>
